...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <?php if ($_SESSION['role'] == 'Admin') : ?>
            <button type="button" class="btn btn-outline-primary" onclick="window.location.href='buku_create.php'">
                <i class="bi bi-cart-plus"></i> Tambah Buku Baru
            </button>
            
        <?php else : ?>
            <button type="button" class="btn btn-outline-primary" onclick="window.location.href='coba_cart.php'">
                <i class="bi bi-cart-plus"></i> Lihat Keranjang
            </button>
        <?php endif; ?>
