                    ...
                    while($data_row = mysqli_fetch_assoc($data)){
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#detail-<?=$id_pesanan?>" aria-expanded="false" aria-controls="detail-<?=$id_pesanan?>">
                                        Detail
                                    </button>
                            ...
                            <tr>
                                <td colspan="8" class="p-0 border-0">
                                    <div class="collapse bg-light" id="detail-<?=$id_pesanan?>">
                                        <div class="card card-body border-0 shadow-sm m-3">
